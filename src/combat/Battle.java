...
public class Battle {
    ...
    public boolean start() {
        ...
        while (!isBattleOver()) {
            ...
            // Check if player quit during heroes' turn
    ...
    private void heroesTurn() {
        ...
        for (Hero hero : party.getHeroes()) {
            ...
            // Check if player quit during this hero's action
            if (playerQuit) break;
    ...
    private void heroAction(Hero hero) {
        while (true) {
            ...
            output.display("Q. Quit game");

            int action = input.readMenuChoice("Enter choice (or 'q' to quit): ", menuOptions.size());
