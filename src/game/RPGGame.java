...
public abstract class RPGGame {
     ...
     */
    public RPGGame() {
        this(new Scanner(System.in), new OutputHandler());
    }

    /**
     * Creates a new RPG game instance with provided Scanner and OutputHandler.
     * Allows sharing of input/output handlers across multiple games.
     * @param scanner The scanner to use for input
     * @param output The output handler to use for display
     */
    public RPGGame(Scanner scanner, OutputHandler output) {
