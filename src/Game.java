 ...
 * Extends HeroesAndMonsters to implement a complete RPG game experience
 * with hero selection, world exploration, battles, and market interactions.
 */
public class Game extends HeroesAndMonsters {
    ...
    protected void initializeGame() {
        ...
        // Create world
        this.world = new World(8, 8, output);
